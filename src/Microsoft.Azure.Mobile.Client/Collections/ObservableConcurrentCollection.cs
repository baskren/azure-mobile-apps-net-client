...
namespace Microsoft.WindowsAzure.MobileServices
{
    public class ObservableConcurrentCollection<T> : ObservableCollection<T>, IEnumerable
    {
        ...
        {
            if (func == null)
                throw new ArgumentException(GetType() + "." + nameof(Aggregate) + ":" + nameof(func));
            ...
            if (!touched)
                throw new InvalidOperationException(GetType() + "." + nameof(Aggregate) + ": No elements.  ");
        ...
        public TResult Aggregate<TAccumulate, TResult>(TAccumulate seed, Func<TAccumulate, T, TAccumulate> func, Func<TAccumulate, TResult> resultSelector)
        {
            ...
            {
                throw new ArgumentException(GetType() + "." + nameof(resultSelector) + ":" + nameof(func));
            }
        ...
        {
            if (predicate == null)
                throw new ArgumentException(GetType() + "." + nameof(All) + ":" + nameof(predicate));
